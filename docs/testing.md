...
```bash
PRIVACY_EMAIL=privacy@example.com SUPPORT_EMAIL=support@example.com SEED_DATA_PATH=app/fixtures/review_seed.json WEBAUTHN_RP_ID=localhost uvicorn app.main:app --reload
```
